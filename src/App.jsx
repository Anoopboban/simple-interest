...
function App() {
 ...
 const [Interest , setInterest]=useState(0)
  ...
  const validate = (e)=>{
    ...
    console.log(name);
    console.log(value);
    // match(regexp) - it returns array when the value matches with the regular expression else returns null
    if(!!value.match('^[0-9]*$')) {
      if(name == 'principle'){
        setPrinciple(value)
        setIsPrinciple(true)
...
const calculate = ()=>{
  ...
  return (
    <>
   <div className='bg-dark d-flex justify-content-center align-item-center' style={{height:'100vh',width:'100%'}}>
